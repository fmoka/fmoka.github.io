...
function basicInit()
{
   ...
   gl.uniform4fv(uColor, white);
	...
	//Get and set bulge multiplier
	bulgingEffectLoc = gl.getUniformLocation(program, "bulge");
	gl.uniform1f(bulgingEffectLoc, 0.0);
   ...
   //Bulging effect slider
   ele = document.getElementById("bulgingEffect");
	ele.onchange = ele.oninput = function(event) {
    var bulgingEffect = (event.srcElement || event.target).value;
    document.getElementById("bulgingEffectVal").innerHTML = bulgingEffect;
	gl.uniform1f(bulgingEffectLoc, bulgingEffect);
   };
   ele.value = 0.0;
   document.getElementById("bulgingEffectVal").innerHTML = 0.0;
